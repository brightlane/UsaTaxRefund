...
UNIVERSITIES = [
    ...
    ("university-of-florida-intl-taxes",      "🐊","University of Florida",     "Gainesville",    "Florida",        "None",        "No state tax",  "Florida has NO state income tax",                "UF STEM, Business, Law — no Florida state income tax, federal 1040-NR only"),
    ("university-of-chicago-intl-taxes",      "🏛️","University of Chicago",      "Chicago",        "Illinois",       "IL-1040",     "4.95% flat",    "Illinois does not recognize treaties",            "UChicago Booth, Law, Harris — Illinois flat 4.95% income tax, no treaty recognition"),
    ("emory-international-student-taxes",     "🦅","Emory University",           "Atlanta",        "Georgia",        "GA Form 500", "5.49% flat",    "Georgia does not fully recognize treaties",       "Emory Goizueta, Medicine, Law — Georgia flat 5.49% income tax"),
    ("georgetown-international-taxes",        "🏛️","Georgetown University",      "Washington DC",  "Washington DC",  "DC D-40B",    "4-10.75%",      "DC does not fully recognize federal tax treaties","Georgetown McDonough, Law, Walsh — DC graduated income tax up to 10.75%"),
    ("george-washington-international-taxes", "🏛️","George Washington",          "Washington DC",  "Washington DC",  "DC D-40B",    "4-10.75%",      "DC does not fully recognize federal tax treaties","GWU Elliott, Columbian — DC graduated income tax, located in Foggy Bottom"),
    ("tufts-international-student-taxes",     "🐘","Tufts University",           "Medford",        "Massachusetts",  "MA 1-NR/PY",  "5% flat",       "Massachusetts partially honors treaties",         "Tufts Fletcher, Engineering, Arts & Sciences — Massachusetts 5% flat income tax"),
    ("boston-college-international-taxes",    "🦅","Boston College",             "Chestnut Hill",  "Massachusetts",  "MA 1-NR/PY",  "5% flat",       "Massachusetts partially honors treaties",         "BC Carroll, Law, Woods College — Massachusetts 5% flat income tax"),
    ("fordham-international-taxes",           "🌹","Fordham University",         "New York City",  "New York",       "IT-203",      "up to 10.9%",   "New York partially honors treaties",              "Fordham Gabelli, Law — NYC Bronx/Manhattan location, NYC income tax applies"),
    ("university-of-notre-dame-intl-taxes",   "☘️","University of Notre Dame",   "South Bend",     "Indiana",        "IN IT-40PNR", "3.15% flat",    "Indiana does not recognize treaties",             "Notre Dame Mendoza, Law, Engineering — Indiana 3.15% flat income tax"),
    ("wake-forest-international-taxes",       "🖤","Wake Forest University",     "Winston-Salem",  "North Carolina", "NC D-400",    "4.5% flat",     "NC does not fully honor treaties",                "Wake Forest Business, Law — North Carolina 4.5% flat income tax"),
    ("tulane-international-student-taxes",    "🌊","Tulane University",          "New Orleans",    "Louisiana",      "LA IT-540B",  "1.85-4.25%",    "Louisiana does not fully recognize treaties",     "Tulane Freeman, Law, Medicine — Louisiana graduated income tax"),
    ("ohio-state-international-taxes",        "🌰","Ohio State University",      "Columbus",       "Ohio",           "OH IT-1040",  "2.765-3.99%",   "Ohio does not fully recognize treaties",          "OSU Fisher, Engineering — Ohio graduated income tax, Columbus 2.5% city tax"),
    ("michigan-state-international-taxes",    "🐍","Michigan State University",  "East Lansing",   "Michigan",       "MI-1040",     "4.25% flat",    "Michigan does not fully recognize treaties",      "MSU Broad, Engineering — Michigan 4.25% flat income tax"),
    ("penn-state-international-taxes",        "🦁","Penn State University",      "State College",  "Pennsylvania",   "PA-40",       "3.07% flat",    "Pennsylvania does not recognize treaties",        "Penn State Smeal, Engineering — Pennsylvania 3.07% flat income tax"),
    ("rutgers-international-student-taxes",   "🔴","Rutgers University",         "New Brunswick",  "New Jersey",     "NJ-1040NR",   "1.4-10.75%",    "New Jersey partially recognizes treaties",        "Rutgers Business, Law — New Jersey graduated income tax"),
    ("university-of-maryland-intl-taxes",     "🐢","University of Maryland",     "College Park",   "Maryland",       "MD Form 505", "2-5.75%",       "Maryland partially honors treaties",              "UMD Smith, Engineering, Computer Science — Maryland graduated income tax"),
    ("virginia-tech-international-taxes",     "🦃","Virginia Tech",              "Blacksburg",     "Virginia",       "VA Form 763", "2-5.75%",       "Virginia partially recognizes treaties",          "VT Engineering, Pamplin — Virginia graduated income tax"),
    ("university-of-minnesota-intl-taxes",    "🐿️","University of Minnesota",   "Minneapolis",    "Minnesota",      "MN Form M1NR","5.35-9.85%",    "Minnesota does not fully recognize treaties",     "UMN Carlson, Engineering — Minnesota has high graduated income tax rates"),
    ("university-of-wisconsin-intl-taxes",    "🧀","University of Wisconsin",    "Madison",        "Wisconsin",      "WI Form 1NPR","3.54-7.65%",    "Wisconsin partially recognizes treaties",         "UW Madison Business, Engineering — Wisconsin graduated income tax"),
    ("washington-university-stl-taxes",       "🐻","Washington University StL",  "St. Louis",      "Missouri",       "MO Form MO-1040","2-4.95%",    "Missouri does not fully recognize treaties",      "WashU Olin, Brown School, Medicine — Missouri graduated income tax"),
    ("arizona-state-international-taxes",     "😈","Arizona State University",   "Tempe",          "Arizona",        "AZ Form 140NR","2.5% flat",    "Arizona does not recognize treaties",             "ASU Carey, Fulton Engineering — Arizona 2.5% flat income tax, one of the lowest"),
    ("university-of-arizona-intl-taxes",      "🐻","University of Arizona",      "Tucson",         "Arizona",        "AZ Form 140NR","2.5% flat",    "Arizona does not recognize treaties",             "UA Eller, Engineering — Arizona 2.5% flat income tax"),
    ("university-of-oregon-intl-taxes",       "🦆","University of Oregon",       "Eugene",         "Oregon",         "OR Form 40N", "4.75-9.9%",     "Oregon does not fully recognize treaties",        "UO Lundquist, Arts and Sciences — Oregon graduated income tax"),
    ("oregon-state-international-taxes",      "🦫","Oregon State University",    "Corvallis",      "Oregon",         "OR Form 40N", "4.75-9.9%",     "Oregon does not fully recognize treaties",        "OSU Engineering, Business — Oregon graduated income tax up to 9.9%"),
    ("university-of-utah-intl-taxes",         "⛷️","University of Utah",         "Salt Lake City", "Utah",           "UT TC-40B",   "4.65% flat",    "Utah does not fully recognize treaties",          "U of U Eccles, Engineering, Medicine — Utah 4.65% flat income tax"),
    ("colorado-state-international-taxes",    "🐏","Colorado State University",  "Fort Collins",   "Colorado",       "CO Form 104", "4.4% flat",     "Colorado does not recognize treaties",            "CSU Engineering, Business — Colorado 4.4% flat income tax"),
    ("texas-am-international-taxes",          "🐾","Texas A&M University",       "College Station","Texas",          "None",        "No state tax",  "Texas has NO state income tax",                  "TAMU Mays, Engineering — no Texas state income tax, federal 1040-NR only"),
    ("university-of-houston-intl-taxes",      "🐆","University of Houston",      "Houston",        "Texas",          "None",        "No state tax",  "Texas has NO state income tax",                  "UH Bauer, Cullen Engineering — no Texas state income tax"),
    ("university-of-pittsburgh-intl-taxes",   "🏈","University of Pittsburgh",   "Pittsburgh",     "Pennsylvania",   "PA-40",       "3.07% flat",    "Pennsylvania does not recognize treaties",        "Pitt Katz, Engineering — Pennsylvania 3.07% flat income tax"),
    ("case-western-reserve-intl-taxes",       "🔬","Case Western Reserve",       "Cleveland",      "Ohio",           "OH IT-1040",  "2.765-3.99%",   "Ohio does not fully recognize treaties",          "CWRU Weatherhead, Engineering — Ohio graduated income tax, Cleveland 2% city tax"),
    ("university-of-iowa-intl-taxes",         "🌽","University of Iowa",         "Iowa City",      "Iowa",           "IA Form IA 1040","4.4-6%",     "Iowa does not fully recognize treaties",          "UI Tippie, Engineering — Iowa graduated income tax"),
    ("iowa-state-international-taxes",        "🌪️","Iowa State University",      "Ames",           "Iowa",           "IA Form IA 1040","4.4-6%",     "Iowa does not fully recognize treaties",          "ISU Business, Engineering — Iowa graduated income tax"),
    ("university-of-kansas-intl-taxes",       "🌻","University of Kansas",       "Lawrence",       "Kansas",         "KS K-40",     "3.1-5.7%",      "Kansas does not fully recognize treaties",        "KU Business, Engineering, Medicine — Kansas graduated income tax"),
    ("kansas-state-international-taxes",      "🐾","Kansas State University",    "Manhattan",      "Kansas",         "KS K-40",     "3.1-5.7%",      "Kansas does not fully recognize treaties",        "K-State Engineering, Business — Kansas graduated income tax"),
    ("university-of-nebraska-intl-taxes",     "🌽","University of Nebraska",     "Lincoln",        "Nebraska",       "NE Form 1040N","2.46-6.64%",   "Nebraska does not fully recognize treaties",      "UNL Business, Engineering — Nebraska graduated income tax"),
    ("university-of-oklahoma-intl-taxes",     "🏈","University of Oklahoma",     "Norman",         "Oklahoma",       "OK Form 511NR","0.25-4.75%",   "Oklahoma does not fully recognize treaties",      "OU Price, Engineering — Oklahoma graduated income tax"),
    ("oklahoma-state-international-taxes",    "🤠","Oklahoma State University",  "Stillwater",     "Oklahoma",       "OK Form 511NR","0.25-4.75%",   "Oklahoma does not fully recognize treaties",      "OSU Spears, Engineering — Oklahoma graduated income tax"),
    ("university-of-kentucky-intl-taxes",     "🏀","University of Kentucky",     "Lexington",      "Kentucky",       "KY Form 740-NP","4.5% flat",   "Kentucky does not fully recognize treaties",      "UK Gatton, Engineering, Medicine — Kentucky 4.5% flat income tax"),
    ("university-of-louisville-intl-taxes",   "🏀","University of Louisville",   "Louisville",     "Kentucky",       "KY Form 740-NP","4.5% flat",   "Kentucky does not fully recognize treaties",      "UofL Speed Engineering, Business — Kentucky 4.5% flat income tax"),
    ("auburn-international-student-taxes",    "🐯","Auburn University",          "Auburn",         "Alabama",        "AL Form 40NR","2-5% graduated","Alabama does not recognize treaties",             "Auburn Harbert, Engineering — Alabama graduated income tax"),
    ("university-of-alabama-intl-taxes",      "🐘","University of Alabama",      "Tuscaloosa",     "Alabama",        "AL Form 40NR","2-5% graduated","Alabama does not recognize treaties",             "UA Culverhouse, Engineering — Alabama graduated income tax"),
    ("lsu-international-student-taxes",       "🐯","LSU",                        "Baton Rouge",    "Louisiana",      "LA IT-540B",  "1.85-4.25%",    "Louisiana does not fully recognize treaties",     "LSU Ourso, Engineering — Louisiana graduated income tax"),
    ("university-of-tennessee-intl-taxes",    "🍊","University of Tennessee",    "Knoxville",      "Tennessee",      "TN Form INC", "No wage tax",   "Tennessee has no income tax on wages",            "UTK Haslam, Engineering — Tennessee no wage income tax, federal only"),
    ("vanderbilt-intl-student-taxes",         "⭐","Vanderbilt University",      "Nashville",      "Tennessee",      "TN Form INC", "No wage tax",   "Tennessee has no income tax on wages",            "Vanderbilt Owen, Engineering, Medicine — Tennessee no wage income tax"),
    ("florida-state-intl-student-taxes",      "🍢","Florida State University",   "Tallahassee",    "Florida",        "None",        "No state tax",  "Florida has NO state income tax",                "FSU Business, Engineering, Law — no Florida state income tax"),
    ("florida-international-intl-taxes",      "🌊","Florida International",      "Miami",          "Florida",        "None",        "No state tax",  "Florida has NO state income tax",                "FIU Business, Engineering — no Florida state income tax, large international student body"),
    ("university-of-central-florida-intl",    "🚀","UCF",                        "Orlando",        "Florida",        "None",        "No state tax",  "Florida has NO state income tax",                "UCF College of Engineering, Business — no Florida state income tax"),
    ("drexel-international-student-taxes",    "🐉","Drexel University",          "Philadelphia",   "Pennsylvania",   "PA-40",       "3.07% flat",    "Pennsylvania does not recognize treaties",        "Drexel LeBow, Engineering — Pennsylvania 3.07%, Philadelphia city wage tax 3.44%"),
    ("temple-international-student-taxes",    "🦉","Temple University",          "Philadelphia",   "Pennsylvania",   "PA-40",       "3.07% flat",    "Pennsylvania does not recognize treaties",        "Temple Fox, Engineering — Pennsylvania 3.07%, Philadelphia city wage tax 3.44%"),
    ("syracuse-international-student-taxes",  "🍊","Syracuse University",        "Syracuse",       "New York",       "IT-203",      "up to 10.9%",   "New York partially honors treaties",              "Syracuse Whitman, Maxwell — New York state income tax, not NYC so no city tax"),
    ("stony-brook-international-taxes",       "🐺","Stony Brook University",     "Stony Brook",    "New York",       "IT-203",      "up to 10.9%",   "New York partially honors treaties",              "Stony Brook SUNY — New York state income tax, Long Island location no NYC tax"),
    ("university-of-connecticut-intl-taxes",  "🐶","University of Connecticut",  "Storrs",         "Connecticut",    "CT-1040NR/PY","2-6.99%",       "Connecticut partially recognizes treaties",        "UConn Business, Engineering — Connecticut graduated income tax"),
    ("university-of-delaware-intl-taxes",     "💙","University of Delaware",     "Newark",         "Delaware",       "DE Form 200-02","0-6.6% graduated","Delaware does not fully recognize treaties",  "UD Lerner, Engineering — Delaware graduated income tax"),
    ("university-of-new-mexico-intl-taxes",   "🌶️","University of New Mexico",   "Albuquerque",    "New Mexico",     "NM PIT-1",    "1.7-5.9%",      "New Mexico does not fully recognize treaties",    "UNM Anderson, Engineering — New Mexico graduated income tax"),
    ("rice-university-intl-taxes",            "🦉","Rice University",            "Houston",        "Texas",          "None",        "No state tax",  "Texas has NO state income tax",                  "Rice Jones, Wiess Engineering — no Texas state income tax, federal 1040-NR only"),
    ("university-of-rochester-intl-taxes",    "🎵","University of Rochester",    "Rochester",      "New York",       "IT-203",      "up to 10.9%",   "New York partially honors treaties",              "UR Simon Business, Engineering, Eastman — New York state income tax"),
    ("rensselaer-international-taxes",        "🔬","Rensselaer (RPI)",           "Troy",           "New York",       "IT-203",      "up to 10.9%",   "New York partially honors treaties",              "RPI Engineering, Science, Management — New York state income tax"),
    ("clemson-international-student-taxes",   "🐯","Clemson University",         "Clemson",        "South Carolina", "SC Form I-290","0-7% graduated","SC does not fully recognize treaties",            "Clemson Engineering, Business — South Carolina graduated income tax"),
    ("university-of-south-carolina-intl",     "🐓","University of South Carolina","Columbia",      "South Carolina", "SC Form I-290","0-7% graduated","SC does not fully recognize treaties",            "USC Moore, Engineering — South Carolina graduated income tax"),
